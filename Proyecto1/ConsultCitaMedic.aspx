<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="true" CodeBehind="ConsultCitaMedic.aspx.cs" Inherits="Proyecto1.ConsultCitaMedic" %>
...
<body>
    ...
    <tr><td colspan="2" class="h1Prin"><h1>Listado Citas</h1></td></tr>
        ...
        <tr>
          <td>  <asp:GridView ID="GVConsultaMedic" CssClass="gridview" runat="server" OnRowCommand ="gridViewConsulta_RowCommand"></asp:GridView> </td>
